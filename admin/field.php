...
switch ($op) {
    case 'list':
        ...
        $field_type_arr = Xmarticle\Utility::fieldTypes();
        if ($field_count > 0) {
    ...
    case 'del':
        ...
        if (0 == $field_id) {
            ...
            if (true === $surdel) {
                ...
                xoops_confirm(['surdel' => true, 'field_id' => $field_id, 'op' => 'del'], $_SERVER['REQUEST_URI'], sprintf(_MA_XMARTICLE_FIELD_SUREDEL, $obj->getVar('field_name')));
            }
        }
