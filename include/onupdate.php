 ...
 */
function xoops_module_pre_update_xmarticle(\XoopsModule $module)
{
...
function xoops_module_update_xmarticle(\XoopsModule $module, $previousVersion = null)
{
    ...
    /** @var Xmarticle\Helper $helper */
    /** @var Xmarticle\Utility $utility */
    /** @var Xmarticle\Configurator $configurator */
    $helper  = Xmarticle\Helper::getInstance();
    $utility = new Xmarticle\Utility();
    $configurator = new Xmarticle\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'xmarticlex_categories';
        $column     = 'ordre';
        $newName    = 'order';
